...
| Coverage > 50% | ✅ 66% coverage | 2 |

## 🧪 Тестирование

### Бэкенд тесты
**Добавлены полноценные интеграционные и E2E тесты :**

- ✅ **15 тестов**, все проходят успешно
- ✅ **Покрытие кода: 66%** (проверено через pytest-cov)
- ✅ **Тесты с правильными данными** → создание записей в БД
- ✅ **Тесты с неправильными данными** → проверка ошибок
